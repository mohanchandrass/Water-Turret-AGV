...
def generate_launch_description():
    ...
    world_path = os.path.join(get_package_share_directory(pkg_name), 'model', 'empty_world.world')

    # Convert Xacro to XML string
    ...
    # joint_state_publisher_gui node (interactive joint sliders)
    ...
    # spawn_entity node to spawn robot in Gazebo
